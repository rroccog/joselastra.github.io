...
```{r ,eval=require('leaflet'), echo=F, error=FALSE, out.width='100%',out.height= '70%',warning=FALSE,message=FALSE}
library(leaflet)
library(tidyverse)
library(sf)
...
-  <ru-blockquote>Tiempo de procesamiento </ru-blockquote>
- Clasificación de puntos
- Generación de un buen DTM, normalización y buen CHM
- Segmentación de copas óptima para el área
...
.pull-right[![:scale 45%](summary_catalog.png)]
